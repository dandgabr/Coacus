...
description: >-
  Specialist Agent in Cloud Security, covering CNAPP posture management, IaC
  security scanning, cloud secrets and workload identity federation, cloud
  detection and response, serverless security and multi-cloud assurance.
skills:
  - knowledge/skills/engineering/practices/clean-code-reusability/SKILL.md
  - knowledge/skills/security/cloud/cloud-detection-response/SKILL.md
  - knowledge/skills/security/cloud/cloud-secrets-management/SKILL.md
  - knowledge/skills/security/cloud/cloud-security-posture-cnapp/SKILL.md
  - knowledge/skills/security/cloud/cloud-workload-identity-federation/SKILL.md
  - knowledge/skills/security/cloud/iac-security-scanning/SKILL.md
  - knowledge/skills/security/cloud/serverless-security/SKILL.md
...
- [cloud-security-posture-cnapp](knowledge/skills/security/cloud/cloud-security-posture-cnapp/SKILL.md)
- [iac-security-scanning](knowledge/skills/security/cloud/iac-security-scanning/SKILL.md)
- [cloud-secrets-management](knowledge/skills/security/cloud/cloud-secrets-management/SKILL.md)
- [cloud-workload-identity-federation](knowledge/skills/security/cloud/cloud-workload-identity-federation/SKILL.md)
- [cloud-detection-response](knowledge/skills/security/cloud/cloud-detection-response/SKILL.md)
- [serverless-security](knowledge/skills/security/cloud/serverless-security/SKILL.md)
