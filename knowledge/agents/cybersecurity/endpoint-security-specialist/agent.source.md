...
description: >-
  Specialist Agent in Endpoint and Platform Security, covering EDR/XDR,
  application control, OS hardening baselines and patch management, macOS
  endpoint security, endpoint detection engineering and host forensics.
skills:
  ...
  - knowledge/skills/security/operations/endpoint-detection-engineering/SKILL.md
  ...
  - knowledge/skills/security/platform/endpoint-application-control/SKILL.md
  - knowledge/skills/security/platform/macos-endpoint-security/SKILL.md
  - knowledge/skills/security/platform/os-hardening-baselines/SKILL.md
  - knowledge/skills/security/platform/windows-internals-security/SKILL.md
---
...
- [endpoint-application-control](knowledge/skills/security/platform/endpoint-application-control/SKILL.md)
- [edr-evasion-endpoint-security](knowledge/skills/security/platform/edr-evasion-endpoint-security/SKILL.md)
- [windows-internals-security](knowledge/skills/security/platform/windows-internals-security/SKILL.md)
- [macos-endpoint-security](knowledge/skills/security/platform/macos-endpoint-security/SKILL.md)
- [endpoint-detection-engineering](knowledge/skills/security/operations/endpoint-detection-engineering/SKILL.md)
