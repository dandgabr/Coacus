...
[![Tests: 241](https://img.shields.io/badge/tests-241-brightgreen.svg)](docs/usage.md)
...
holds 241 deterministic stdlib `unittest` tests. `evals/` holds six behavior
...
python3 -m unittest discover -s tests   # 241 deterministic tests
