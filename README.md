...
[![Tests: 229](https://img.shields.io/badge/tests-229-brightgreen.svg)](docs/usage.md)
...
holds 229 deterministic stdlib `unittest` tests. `evals/` holds four behavior
...
python3 -m unittest discover -s tests   # 229 deterministic tests
